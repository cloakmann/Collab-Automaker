...
//room transition modes
global.stageEndEffect = 1;    //enable room transition effect after finishing each stage
global.stageEndKind = 22;    //index of stage transition effect
global.roomEndEffect = 1;    // enable room transition effect after finishing each room
global.roomEndKind = 21;    //index of room transition effect
global.gameClearEffect = 1;    // enable room transition effect after game clear
global.gameClearKind = 21;    //index of game clear transition effect
...
global.roomCaptionDef = "Speedy_Mar09";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = room_next(rDifficultySelect);
