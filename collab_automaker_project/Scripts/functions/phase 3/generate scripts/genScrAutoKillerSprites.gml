...
var f;
f = file_text_open_write(global.scriptDir + '\scrAutoKillerSprites.gml');
...
writeWithBreak(f,"///scrAutoKillerSprites()");
...
objName[7]='MiniDown';
objName[8]='Cherry';
objName[9]='KillerBlock';
objName[10]='MiniKillerBlock';
...
tabLog();
addLog("generating scrAutoKillerSprites for " + string(ds_list_size(stageValueList)) + " stages");
